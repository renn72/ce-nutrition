...
const parseTime = (value?: string | null): TimeValue => {
  if (!value || value.trim() === '') return getCurrentTimeValue()
...
const getCurrentRoundedTime = () => to24HourTime(getCurrentTimeValue())
...
export { BloodGlucoseTimePicker, getCurrentRoundedTime }
