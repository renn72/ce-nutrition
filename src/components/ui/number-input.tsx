...
const NumberInput = ({
	...
	return (
		<div
			className={cn(
				'w-60 relative border rounded-lg h-16 flex items-center shadow-sm',
				isSmall ? 'h-10 w-32' : '',
				className,
				height ? height : '',
			)}
		>
			<Input
				...
				className={cn(
					'relative w-full text-xl font-medium rounded-lg text-center h-min border-none',
			...
			>
				<div
					className={cn(
						'h-16 w-14 flex items-center justify-center active:scale-75',
						isSmall ? 'w-10 h-10' : 'w-14',
						height ? height : '',
					)}
				>
