...
type TreeContextType = {
  ...
  handleSelection: (nodeId: string, isFolder : boolean, ctrlKey: boolean) => void;
  showLines?: boolean;
  showIcons?: boolean;
  selectable?: boolean;
  multiSelect?: boolean;
...
export const TreeProvider = ({
  ...
  const handleSelection = useCallback(
    (nodeId: string, isFolder : boolean, ctrlKey = false) => {
      if (!selectable) {
        return;
      }
      if (isFolder) return
...
export const TreeNodeTrigger = ({
  ...
  const { nodeId, isFolder, level } = useTreeNode();
  ...
  return (
    <motion.div
      ...
      onClick={(e) => {
        ...
        handleSelection(nodeId, isFolder, e.ctrlKey || e.metaKey);
        onClick?.(e);
      }}
