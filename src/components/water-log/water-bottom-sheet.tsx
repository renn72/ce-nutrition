...
import { ChevronDown, ListCollapse, Settings, Trash2 } from 'lucide-react'
					...
					<Sheet.Content className='min-h-[200px] max-h-[80vh] h-full rounded-t-3xl bg-background relative'>
						<div className='flex flex-col justify-between h-full'>
							<div className='flex flex-col '>
								...
								<div className='flex items-center gap-0 pt-1 relative w-min ml-4'>
									<Label className='mr-4'>Size</Label>
									{size}
									<span className='text-xs text-primary/50 mt-[1px]'>ml</span>
									<Link
										href='/user/settings#settings-user-email'
										className=' ml-4 mb-[4px]'
									>
										<Settings size={20} strokeWidth={1.5} className='cursor-pointer' />
									</Link>
								</div>
