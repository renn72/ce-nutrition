...
--> statement-breakpoint
CREATE INDEX `ingredient_food_key_idx` ON `ingredient` (`public_food_key`);--> statement-breakpoint
CREATE INDEX `ingredient_food_name_idx` ON `ingredient` (`food_name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `ingredient_to_grocery_store` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created_at` integer DEFAULT (unixepoch()) NOT NULL,
	`ingredient_id` integer,
...
--> statement-breakpoint
CREATE TABLE `meal_to_vege_stack` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created_at` integer DEFAULT (unixepoch()) NOT NULL,
	`meal_id` integer,
...
CREATE INDEX `clerk_id_idx` ON `user` (`clerk_id`);--> statement-breakpoint
CREATE INDEX `name_idx` ON `user` (`name`);--> statement-breakpoint
CREATE TABLE `user_to_trainer` (
	`user_id` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `skinfold_date_idx` ON `skinfold` (`date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `body_fat_date_idx` ON `body_fat` (`date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `body_weight_date_idx` ON `body_weight` (`date`);--> statement-breakpoint
CREATE TABLE `lean_mass` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created_at` integer DEFAULT (unixepoch()) NOT NULL,
	`user_id` text NOT NULL,
	`date` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `lean_mass_date_idx` ON `lean_mass` (`date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `date_idx` ON `daily_log` (`date`);--> statement-breakpoint
