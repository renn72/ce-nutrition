...
const mealAccentStyles = {
	section: 'border-primary/12 bg-primary/[0.04]',
	dot: 'bg-primary/70',
	average: 'border-primary/15 bg-primary/[0.11] text-foreground',
} as const
...
const UserPlanRecipe = ({
	...
	return (
		...
		>
			<Sheet.Trigger className='overflow-hidden py-2 px-2.5 w-full text-left border transition-transform rounded-[18px] border-primary/12 bg-card shadow-[0_14px_22px_-20px_hsl(var(--foreground)/0.55)] active:scale-[0.99]'>
				<div className='flex gap-3 justify-between items-start'>
					...
					<div className='py-1 px-2 font-semibold rounded-2xl border shrink-0 border-primary/15 bg-primary/[0.12] text-[10px] text-primary'>
				...
				<div className='grid grid-cols-3 gap-1.5 mt-2'>
					{[
						...
						<div
							key={item.label}
							className='py-1 px-2 rounded-2xl border border-primary/10 bg-primary/[0.045]'
						>
...
const UserPlanView = ({ userPlan }: { userPlan: UserPlan }) => {
	...
	return (
		<Card className='overflow-hidden gap-0 py-0 rounded-none border-border/70 shadow-[0_20px_48px_-32px_hsl(var(--foreground)/0.45)]'>
			<CardHeader className='gap-3 px-3 pt-4 pb-3 border-b border-border/60 bg-primary/[0.06]'>
				<div className='flex gap-3 justify-between items-start'>
				...
				<div className='grid grid-cols-2 gap-2'>
					<div className='py-2 px-2.5 rounded-2xl border border-primary/12 bg-background/90'>
						<div className='uppercase text-[10px] tracking-[0.14em] text-primary/80'>
							Meals
						</div>
						<div className='mt-1 text-sm font-semibold'>{mealCount}</div>
					</div>
					<div className='py-2 px-2.5 rounded-2xl border border-primary/15 bg-primary/[0.12]'>
						<div className='uppercase text-[10px] tracking-[0.14em] text-primary/80'>
							Recipes
						</div>
